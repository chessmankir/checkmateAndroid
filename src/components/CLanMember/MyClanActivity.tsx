    ...
    return (
        <View style={styles.memberActivityBox}>
            <View style={styles.activityItem}>
                ...
                <Text style={styles.activityValue}>{activity?.week ?? 0} сообщений</Text>
            </View>

            <View style={styles.activityItem}>
                <Text style={styles.activityLabel}>За месяц</Text>
                <Text style={styles.activityValue}>{activity?.month ?? 0} сообщений</Text>
            </View>
            <View style={styles.activityItem}>
                <Text style={styles.activityLabel}>Всего</Text>
                <Text style={styles.activityValue}>{activity?.total ?? 0} сообщений</Text>
            </View>

            <View style={styles.activityItem}>
                <Text style={styles.activityLabel}>Последнее сообщение</Text>
                <Text style={styles.activityValue}>{getFormatDate(activity?.last_message_at)}</Text>
            </View>
        </View>
    )
}